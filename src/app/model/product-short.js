...
var ProductShort = (function () {
    function ProductShort(id, name, price, oldPrice, bonuses, manufacturerId, Props, imageUrl, rating, recall, supplOffers, 
