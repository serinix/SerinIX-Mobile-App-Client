...
var ProductPropValueShort = (function () {
    function ProductPropValueShort(idProp, pVal, prop_Value_Number, prop_Value_Bool, prop_Value_Enum, prop_Value_Long, id_Measure_Unit, idx, out_bmask) {
        this.idProp = idProp;
        this.pVal = pVal;
    ...
    Object.defineProperty(ProductPropValueShort.prototype, "value", {
        get: function () {
